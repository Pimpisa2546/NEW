  ...
  const handleChatWithSeller = async () => {
    if (memberId !== null && product) {
      ...
      if (memberId === product.SellerID) {
        message.error("ไม่สามารถแชทกับผู้ขายได้");
        return;
      }
      ...
      if (result) {
        ...
        message.error(result.message || "เกิดข้อผิดพลาดในการสร้างห้องแชท");
      }
    }
  };
      ...
      <div className="review-page-Bymember">
        ...
        <div className="review-container">
          {reviews.length > 0 ? (
            ...
            <p>ยังไม่มีรีวิวสินค้า</p> // แสดงข้อความนี้เมื่อไม่มีรีวิว
          )}
        </div>
      </div>
    </div>
